...
(function(){
    ...
    jiraConfig.getUrls = function getUrls (uri, path) {
        var urilist = {
            projects : uri + path + '/project',
            project  : uri + path + '/project/{projectid}',
            versions : uri + path + '/project/{projectid}/versions',
            version : uri + path + '/project/{projectid}/versions/{versionid}'
        };
        return urilist;
    };
}());
